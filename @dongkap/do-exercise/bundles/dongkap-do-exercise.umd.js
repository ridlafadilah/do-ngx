(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@nebular/theme'), require('@dongkap/do-theme'), require('@dongkap/do-common'), require('@angular/router'), require('@angular/platform-browser'), require('tree-ngx'), require('@dongkap/do-core')) :
    typeof define === 'function' && define.amd ? define('@dongkap/do-exercise', ['exports', '@angular/core', '@angular/forms', '@nebular/theme', '@dongkap/do-theme', '@dongkap/do-common', '@angular/router', '@angular/platform-browser', 'tree-ngx', '@dongkap/do-core'], factory) :
    (global = global || self, factory((global.dongkap = global.dongkap || {}, global.dongkap['do-exercise'] = {}), global.ng.core, global.ng.forms, global['@nebular/theme'], global['@dongkap/do-theme'], global['@dongkap/do-common'], global.ng.router, global.ng.platformBrowser, global['tree-ngx'], global['@dongkap/do-core']));
}(this, (function (exports, core, forms, theme, doTheme, doCommon, router, platformBrowser, treeNgx, doCore) { 'use strict';
    ...
    var ExerciseComponent = /** @class */ (function () {
        function ExerciseComponent(formBuilder, _d) {
            ...
            this.minLength = 5;
            this.pattern = doCore.DatePattern.SLASH;
            this.rows = [];
            this.columns = [
            ...
            this.formGroup = this.formBuilder.group({
                ...
                'textarea': [{
                    ...
                    [forms.Validators.minLength(this.minLength)]],
                'ckeditor': [{
                        value: '<p>CKEditor</p>',
                        disabled: false,
                    }],
    ...
    exports.DoExerciseModule = DoExerciseModule;
    exports.ExerciseComponent = ExerciseComponent;
    exports.ɵa = DoExerciseRoutingModule;
    exports.ɵb = DoExerciseComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=dongkap-do-exercise.umd.js.map
