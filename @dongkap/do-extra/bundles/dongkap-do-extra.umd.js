(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@nebular/theme'), require('@dongkap/do-theme'), require('@dongkap/do-common'), require('rxjs/operators'), require('@dongkap/do-core'), require('@angular/router'), require('@dongkap/do-auth'), require('@ngx-translate/core'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@dongkap/do-extra', ['exports', '@angular/core', '@angular/forms', '@nebular/theme', '@dongkap/do-theme', '@dongkap/do-common', 'rxjs/operators', '@dongkap/do-core', '@angular/router', '@dongkap/do-auth', '@ngx-translate/core', 'rxjs'], factory) :
    (global = global || self, factory((global.dongkap = global.dongkap || {}, global.dongkap['do-extra'] = {}), global.ng.core, global.ng.forms, global['@nebular/theme'], global['@dongkap/do-theme'], global['@dongkap/do-common'], global.rxjs.operators, global['@dongkap/do-core'], global.ng.router, global['@dongkap/do-auth'], global['@ngx-translate/core'], global.rxjs));
}(this, (function (exports, core, forms, theme, doTheme, doCommon, operators, doCore, router, doAuth, core$1, rxjs) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var ChangePasswordPageComponent = /** @class */ (function (_super) {
        ...
        function ChangePasswordPageComponent(injector) {
            ...
            _this.passwordPattern = doCore.Pattern.PASSWORD_MEDIUM;
            _this.enc = injector.get(doCore.EncryptionService);
            _this.oauthResource = injector.get(doCore.OAUTH_INFO);
            return _this;
        }
            ...
            _super.prototype.onSubmit.call(this, data, 'security', 'change-password')
                ...
                if (response) {
                    switch (response.respStatusCode) {
                        case doCore.ResponseCode.ERR_SCR0002.toString():
                            _this.formGroup.controls['password'].setErrors({
                                'incorrect': true,
                            });
                            break;
                        case doCore.ResponseCode.ERR_SCR0006.toString():
    ...
    var ProfilePageComponent = /** @class */ (function (_super) {
        ...
        function ProfilePageComponent(injector, userService, profileIndexedDB, authIndexedDB) {
            ...
            _this.patternEmail = doCore.Pattern.EMAIL;
            _this.patternPhoneNumber = doCore.Pattern.PHONE_NUMBER;
            _this.minLength = 5;
        ...
        ProfilePageComponent.prototype.onSubmit = function () {
            ...
            _super.prototype.onSubmit.call(this, data, 'profile', 'change-profile')
                ...
                if (response) {
                    switch (response.respStatusCode) {
                        case doCore.ResponseCode.ERR_SCR0008.toString():
                            _this.formGroup.controls['email'].setErrors({
                                'email': true,
                            });
                            break;
                        case doCore.ResponseCode.ERR_SCR0007A.toString():
                            _this.formGroup.controls['phoneNumber'].setErrors({
                                'error.pattern.phoneNumber': true,
                            });
                            break;
                        case doCore.ResponseCode.OK_SCR004.toString():
        ...
        ProfilePageComponent.ctorParameters = function () { return [
            ...
            { type: doAuth.AuthIndexedDBService }
        ]; };
    ...
    var SettingsPageComponent = /** @class */ (function (_super) {
            ...
            Promise.all([
                ...
                if ((current[0] !== _this.localeCode) || (current[1] !== data['theme'])) {
                    _this.exec('security', 'change-settings', data).subscribe(function (success) {
                        if (success) {
                            if (success.respStatusCode === doCore.ResponseCode.OK_SCR002.toString()) {
                                if (theme) {
        ...
        SettingsPageComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: [doCore.SETTINGS_INDEXED_DB,] }] },
    ...
    var SecurityPageComponent = /** @class */ (function (_super) {
        ...
        function SecurityPageComponent(injector, dialogService, authIndexedDB) {
            ...
            _this.enc = injector.get(doCore.EncryptionService);
            _this.oauthResource = injector.get(doCore.OAUTH_INFO);
            _this.authToken = injector.get(doAuth.AuthTokenService);
            _this.authIndexedDB.getEnc('provider').then(function (value) {
                _this.provider = {
                    'value': value,
                };
                ...
                this.dialogService.open(DeactivatedProviderPromptComponent)
                    ...
                    if (email) {
                        ...
                        _super.prototype.onSubmit.call(_this, data, 'security', 'deactivated')
                            ...
                            .subscribe(function (response) {
                            if (response) {
                                if (response.respStatusCode === doCore.ResponseCode.OK_SCR003.toString()) {
    ...
    var modules = [
        ...
        doCommon.DoEditorModule,
        doCommon.DoSelectModule,
        doCommon.DoDatePickerModule,
        doCommon.DoImageModule,
    ...
    exports.ɵa = DoExtraRoutingModule;
    exports.ɵb = ExtraComponent;
    exports.ɵc = ProfilePageComponent;
    exports.ɵd = SystemPageComponent;
    exports.ɵe = SecurityPageComponent;
    exports.ɵf = SettingsPageComponent;
    exports.ɵg = TermsConditionsPageComponent;
    exports.ɵh = PrivacyPolicyPageComponent;
    exports.ɵi = ChangePasswordPageComponent;
    exports.ɵj = DeactivatedPromptComponent;
    exports.ɵk = DeactivatedProviderPromptComponent;
