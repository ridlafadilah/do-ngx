import { APIModel, HttpMethod } from '@dongkap/ngx-core';
...
export const apiPath: APIModel = {
    ...
    panic: {
        'get-allpanic': {
            ...
            method: HttpMethod.GET,
            path: '/do/api/panic/vw/auth/panic/v.1',
        },
        'datatable-panic-detail': {
            server: environment.host.panic,
            method: HttpMethod.POST,
            path: '/do/api/panic/vw/post/datatable/panic-detail/v.1',
        },
        'datatable-panic-reports': {
            server: environment.host.panic,
            method: HttpMethod.POST,
            path: '/do/api/panic/vw/post/datatable/panic-reports/v.1',
        },
        'datatable-fake-reports': {
            server: environment.host.panic,
            method: HttpMethod.POST,
            path: '/do/api/panic/vw/post/datatable/fake-reports/v.1',
        },
        'process-report': {
            server: environment.host.panic,
            method: HttpMethod.POST,
            path: '/do/api/panic/trx/auth/process-panic/v.1',
        },
        'fake-report': {
            server: environment.host.panic,
            method: HttpMethod.POST,
            path: '/do/api/panic/trx/auth/fake/v.1',
        },
        'statistics-area': {
            server: environment.host.panic,
            method: HttpMethod.GET,
            path: '/do/api/panic/vw/auth/statistics-area/v.1',
        },
        'statistics-gender': {
            server: environment.host.panic,
            method: HttpMethod.GET,
            path: '/do/api/panic/vw/auth/statistics-gender/v.1',
        },
        'statistics-periode': {
            server: environment.host.panic,
            method: HttpMethod.GET,
            path: '/do/api/panic/vw/auth/statistics-periode/v.1',
        },
    },
};
